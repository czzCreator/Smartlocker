#ifndef IMP_HTTPREQUEST_H
#define IMP_HTTPREQUEST_H
...
*/
class HttpRequestImp : public QObject, public QQmlParserStatus
{
    Q_OBJECT
    Q_INTERFACES(QQmlParserStatus)
    Q_PROPERTY(QString responseText READ getResponseText NOTIFY responseTextChanged)
    Q_PROPERTY(HttpRequestImp::State readyState READ getReadyState NOTIFY readyStateChanged)
    Q_PROPERTY(HttpRequestImp::NetworkStatus status READ getStatus  NOTIFY statusChanged)
...
public:
    ...
    explicit HttpRequestImp(QObject *parent = Q_NULLPTR);

    explicit HttpRequestImp(QNetworkAccessManager* networkManager, QObject *parent);
...
public:
    ...
    Q_INVOKABLE HttpRequestImp* create();
